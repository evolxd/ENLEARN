...
| 2026-08-05 | Standard GA dictionary knowledge (same 403 limitation) for Part III Batch 5's 30 lexicon entries; cross-check against Cambridge/Oxford flagged as outstanding, especially *address* given noted noun-form stress variability | Part III, Batch 5 (`words_121-150.md`) |
...
| 2026-08-05 | Standard GA dictionary knowledge (same 403 limitation) for Part III Batch 10's 60 lexicon entries; cross-check against Cambridge/Oxford flagged as outstanding, especially *survey*'s noun/verb stress shift, *rehabilitation*'s six-syllable stress pattern, and *sibling*/*upbringing*'s velar nasal /ŋ/, a newly flagged risk not directly documented in Part IV | Part III, Batch 10 (`words_361-390.md`, `words_391-420.md`) |
